...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['filtrar'])) {
    ...
    $livroController->filtrarLivros($pagina);
}
...
<head>
    ...
    <link rel="shortcut icon" href="Public/Assets/_31554896-b491-466e-b129-d77e088c3b0c-removebg-preview.png"
        type="image/x-icon">
    ...
    <img style="border-radius: 100px;" src="Public/Assets/Grey Minimalist Bookstore Business Logo (3).png" width="100px">
        ...
        <div class="user-info" id="user-info">
            ...
            include '../Login/verifica_login.php'
                ?>
            <h3>Olá
                <?php echo $_SESSION['usuarioNomedeUsuario'], "!"; ?>
            </h3><br>
            ...
            <button id="log" onclick="logout()"><ion-icon name="log-out-outline"></ion-icon></button>
        </div>
    </header>
    <section>
        <div class="acervo">
        ...
        <div>
            <form method="POST">
                ...
                <button type="submit" name="filtrar">Filtrar</button><br><br>
            </form>
        </div>
                            ...
                            <li>
                                <div class="livrobox">
                                    ...
                                    if (!empty($livro['imagem'])) {
                                        echo '<img src="../uploads/' . $livro['imagem'] . '" alt="Imagem do Livro" width="100">';
                                    } else {
                                        echo 'Sem Imagem';
                                    }
                                    ?>
                                    ...
                                    <strong>
                                        <?php echo $livro['quantidade']; ?> Livro(s)
                                    </strong> Disponíveis
                                    <form method="post" action="book.php">
